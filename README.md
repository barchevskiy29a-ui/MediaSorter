...
Сканирует указанную папку, извлекает дату съёмки из метаданных (EXIF, QuickTime, XMP) или имени файла и раскладывает файлы по папкам `dd.MM.yyyy`.

## Возможности

- **Извлечение даты** из EXIF (DateTimeOriginal, DateTimeDigitized, DateTime), QuickTime (MOV, MP4, HEIC), XMP, имени файла
